...
-- MOD02 layers
    EV_Reflective_Band_1                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_250_Aggr1km_RefSB', prefix '0'),
    EV_Reflective_Band_2                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_250_Aggr1km_RefSB', prefix '1'),
    EV_Reflective_Band_3                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_500_Aggr1km_RefSB', prefix '0'),
    EV_Reflective_Band_4                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_500_Aggr1km_RefSB', prefix '1'),
    EV_Reflective_Band_5                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_500_Aggr1km_RefSB', prefix '2'),
    EV_Reflective_Band_6                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_500_Aggr1km_RefSB', prefix '3'),
    EV_Reflective_Band_7                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_500_Aggr1km_RefSB', prefix '4'),
    EV_Reflective_Band_8                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '0'),
    EV_Reflective_Band_9                 float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '1'),
    EV_Reflective_Band_10                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '2'),
    EV_Reflective_Band_11                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '3'),
    EV_Reflective_Band_12                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '4'),
    EV_Reflective_Band_13lo              float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '5'),
    EV_Reflective_Band_13hi              float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '6'),
    EV_Reflective_Band_14lo              float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '7'),
    EV_Reflective_Band_14hi              float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '8'),
    EV_Reflective_Band_15                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '9'),
    EV_Reflective_Band_16                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '10'),
    EV_Reflective_Band_17                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '11'),
    EV_Reflective_Band_18                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '12'),
    EV_Reflective_Band_19                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '13'),
    -- EV_Reflective_Band_26Day             float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_RefSB', prefix '14'),
    EV_Emissive_Band_20                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '0'),
    EV_Emissive_Band_21                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '1'),
    EV_Emissive_Band_22                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '2'),
    EV_Emissive_Band_23                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '3'),
    EV_Emissive_Band_24                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '4'),
    EV_Emissive_Band_25                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '5'),
    EV_Reflective_Band_26                float8  OPTIONS (cat_name 'mod021km', dataset 'EV_Band26'),
    EV_Emissive_Band_27                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '6'),
    EV_Emissive_Band_28                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '7'),
    EV_Emissive_Band_29                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '8'),
    EV_Emissive_Band_30                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '9'),
    EV_Emissive_Band_31                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '10'),
    EV_Emissive_Band_32                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '11'),
    EV_Emissive_Band_33                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '12'),
    EV_Emissive_Band_34                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '13'),
    EV_Emissive_Band_35                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '14'),
    EV_Emissive_Band_36                  float8  OPTIONS (cat_name 'mod021km', dataset 'EV_1KM_Emissive', prefix '15'),
